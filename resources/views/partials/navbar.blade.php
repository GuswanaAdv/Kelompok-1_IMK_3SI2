        ...
        <div class="hidden sm:ml-6 sm:block lg:mr-52 ">
          <div class="flex space-x-4">
            <ul class="menu menu-horizontal px-2">
              <li class="md:ml-4 lg:ml-8 fade-up"><a href="{{ route('beranda') }}" class="{{$judul_halaman=='Beranda'? 'bg-green bg-opacity-50':''}} text-white hover:bg-green hover:bg-opacity-25 rounded-md px-2 py-2 text-xs font-roboto font-bold " aria-current="page">BERANDA</a></li>
              <li class="md:ml-4 lg:ml-8 fade-down">
                <details>
                  ...
                  <ul id="pc-sub-profilfasilitas" class="p-2 bg-base-100 rounded-t-none">
                    <li>
                      <details>
              ...
              <li class="md:ml-4 lg:ml-8 fade-down">
                <details>
                  ...
                  <ul id="pc-sub-datadesa" class="p-2 bg-base-100 rounded-t-none">
