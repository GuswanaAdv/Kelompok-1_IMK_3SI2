  ...
  <main class="container mx-auto my-8 bg-white px-24 py-8 rounded-lg shadow-lg">
    <article>
      ...
      <div class="flex justify-between items-center mb-2">
        ...
        <div class="flex items-center">
          <div class="flex items-center space-x-2">
            ...
            <button data-collapse-target="collapse" class="btn_print text-gray-500 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6">
      ...
      <div data-collapse="collapse" class="block h-0 w-full mb-4 basis-full overflow-hidden transition-all duration-300 ease-in-out">
        <div class="relative mt-0 flex w-full flex-col bg-green-100 bg-clip-border text-gray-700">
          test
        </div>
      </div>
