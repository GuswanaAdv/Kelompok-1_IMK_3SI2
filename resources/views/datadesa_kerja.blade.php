...
<div class="mx-0 sm:mx-10 my-10 mt-0">
    <div class="grid md:grid-cols-2 gap-6">
      <!-- Data Table -->
      <div class="bg-white shadow-lg p-4 rounded-lg fade-right">
        ...
        <table id="dataTable" class="text-xs sm:text-base mt-1 w-full border-collapse border border-gray-400">
          <thead>
            <tr>
...
function updateChartFromTable() {
    ...
    const maleData = [];
    const femaleData = [];
    const dataLabels = ['Belum Kerja', 'Pelajar', 'PNS', 'Pedagang', 'Karyawan', 'Buruh', 'Wiraswasta', 'Lainnya']
