...
<div class="container mx-auto mt-0 flex">
    ...
    <main class="md:w-3/4 md:ml-4 p-4 bg-white shadow-md">
        <h2 class="bg-darkgreen text-white py-2 rounded text-center text-2xl font-bold mb-4 fade-down">Fasilitas Kesehatan</h2>

        <div class="mb-7 pt-4">
            <p class="mb-4 ml-4 font-roboto fade-in">Berikut daftar fasilitas kesehatan 
